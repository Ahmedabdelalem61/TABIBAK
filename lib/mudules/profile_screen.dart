          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 5,),
                          Text('any data that will come ', style: Theme
                              .of(context)
                              .textTheme
                              .caption!
                              .copyWith(
                    ...
                    child: Card(
                      ...
                      child: Column(
                        children: [
                          Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                SizedBox(width: 10,),
                                Text(
                                  'Ahmed.abdelam61@gmail.com', style: TextStyle(
                                  fontFamily: 'spartman',
                                  color: Colors.blueGrey,
                                ),)
                              ],
                            ...
                            child: Row(
                              children: [
                                Icon(Icons.phone_android, size: 20,
                                  color: Colors.blueGrey,),
                                SizedBox(width: 10,),
                                Text('+2011459031', style: TextStyle(
                                  fontFamily: 'spartman',
                                  color: Colors.blueGrey,
                                ),)
                              ],
                          ...
                          SizedBox(height: 20,),
                          Text('Edit your personnel information',
                            style: TextStyle(
                                fontFamily: 'spartman'
                            ),),
                ...
                Text('here is your medical analysis distribution\nand your test result of Disease ', style: Theme
                    .of(context)
                    .textTheme
                    .caption!
                    .copyWith(
